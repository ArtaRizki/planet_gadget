...
import 'package:planet_gadget/presentation/pages/account/edit_account_page.dart';
...
class SettingAccountPage extends StatefulWidget {
  SettingAccountPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      child: Scaffold(
        ...
        appBar: appBarWidget(title: "Setting Account", context: context),
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          TextFormField(
            ...
            decoration: viewOnlyDecoration(value, false),
