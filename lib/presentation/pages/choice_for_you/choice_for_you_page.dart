...
class ChoiceForYouPage extends StatefulWidget {
  const ChoiceForYouPage({super.key});

  @override
  State<ChoiceForYouPage> createState() => _ChoiceForYouPageState();
}

class _ChoiceForYouPageState extends State<ChoiceForYouPage> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      child: Scaffold(
        ...
        appBar: appBarWidget(title: "Choice for you", context: context),
