...
import '../store_pickup/store_pickup_page.dart';
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          SvgPicture.asset(
                              "${iconsPaymentPath}pending_payment.svg"),
                          const SizedBox(height: 28),
                          Text("Pending Payment", style: inter20Bold()),
                          const SizedBox(height: 12),
                          Text(
                              "Please pay Rp12.999.000 before 30 May 2023 15:10. Go to My Purchases for more info.",
                    ...
                    Padding(
                      ...
                      child: Text("Choice for you", style: inter16Bold()),
                    ),
                    GridView.builder(
